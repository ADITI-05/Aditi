...
class Batsman :public Cricketer
{
	public:
		void total_run()
		{
			cout<<endl<<"Total runs"<<Cricketer::team1<<" : "<<Cricketer::t1score;
			cout<<endl<<"Total runs"<<Cricketer::team2<<" : "<<Cricketer::t2score;
		}
		void average_runs()
		{
			cout<<endl<<"Total runs"<<Cricketer::team1<<" : "<<Cricketer::avgt1;
	    	cout<<endl<<"Total runs"<<Cricketer::team2<<" : "<<Cricketer::avgt2;
		}
};
int main()
{
